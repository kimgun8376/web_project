// product.js
// element.insertAdjacentHTML('beforebegin/afterbegin/beforeemd/afterend','');
// <span></span><div><span></span><span></span><span></span></div>
let productDate = JSON.parse(localStorage.getItem('productData'));
console.log(productDate)
// 상품갯수만큼 반복생성.
productDate.forEach(function(product) {
